...
\textbf{Суть:} Если все условия задачи зависят от линейной комбинации переменных $\xi = \alpha_1 x_1 + \dots + \alpha_n x_n = \sum \alpha_i x_i$, причем $f(x,t) = \tilde{f}(\xi, t)\big|_{\xi = \sum \alpha_i x_i}$. \\
